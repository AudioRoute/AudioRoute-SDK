...
#define LOGI(...) \
  __android_log_print(ANDROID_LOG_INFO, "audioroute_internal", __VA_ARGS__)
#define LOGW(...) \
  __android_log_print(ANDROID_LOG_WARN, "audioroute_internal", __VA_ARGS__)
#define LOGD(...) \
...
#else
#define AUDIOROUTE_LOCK_TIMEBASE CLOCK_REALTIME
#endif
