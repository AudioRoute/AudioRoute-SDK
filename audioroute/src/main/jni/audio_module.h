 ...
 * in the context that may be modified concurrently must be protected (e.g. using atomic swaps or
...
/*
 * audioroute_configure_java be called in place of audioroute_configure. Since the implementation is inline allows the app to avoid linking the audioroute native lib
 */
